 ...
 * Used by openmeteo_get_forecast, openmeteo_get_historical, openmeteo_get_ensemble,
 * openmeteo_get_flood, and openmeteo_get_climate for large result-set spillover.
